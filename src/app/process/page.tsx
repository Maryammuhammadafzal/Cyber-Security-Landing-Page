...
const ProcessPage = () => {
    return (
        <div className="about mb-0 sm:p-0 px-4 gap-8 sm:w-[90%] md:w-[99%] lg:w-[85%] w-full mx-auto flex-col h-auto flex justify-center  items-center xl:py-30 md:mt-0 sm:mt-50 xs:mt-40 mt-30 lg:py-24 md:py-18 sm:py-12 xs:py-7 py-5">
